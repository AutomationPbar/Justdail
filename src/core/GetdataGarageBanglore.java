...
public class GetdataGarageBanglore {
	...
	public void getdata() throws Exception{
		...
		driver.get("https://www.justdial.com/Banglore/Garages");
		...
		driver.manage().window().maximize();
		  ...
		  for (int pageno =1;pageno<=2;pageno++){
			  ...
			  baseurl = "https://www.justdial.com/Bangalore/Garages/nct-10222543/page-"+pageno;
